...
public class StmtSwitchForListView extends MyStmtSwitch {

    public StmtSwitchForListView(SootMethod currentSootMethod) {
        super(currentSootMethod);
    }

    public StmtSwitchForListView(ListViewInfo listViewInfo, SootMethod currentSootMethod){
        super(listViewInfo, currentSootMethod);
    }

    public StmtSwitchForListView(SootMethod currentSootMethod, Map<String, String> dynStrings, Map<String, String> elementIds){
