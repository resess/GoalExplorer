...
public class Manifest {
	 ...
	 */
	public Manifest(String apkPath) throws IOException, XmlPullParserException {
	 ...
	 * @throws	IOException				if an I/O error occurs.
	 * @throws	XmlPullParserException	can occur due to a malformed manifest.
	 * @see		{@link Manifest#Manifest(InputStream)}
	 */
	public Manifest(File apkFile) throws IOException, XmlPullParserException {
	 ...
	 * @throws	XmlPullParserException	can occur due to a malformed manifest.
	 */
	public Manifest(InputStream manifestIS) throws IOException, XmlPullParserException {
		this.handle(manifestIS);
	}
	
	/**
	 * Initialises the {@link Manifest} by parsing the manifest provided by the given {@link InputStream}.
	 * 
	 * @param	manifestIS				InputStream for an AppManifest.
	 * @throws	IOException				if an I/O error occurs.
	 * @throws	XmlPullParserException	can occur due to a malformed manifest.
	...
	/**
	 * Returns the handler which opened the APK file. If {@link Manifest} was
